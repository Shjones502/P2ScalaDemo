...
object generator {
  def main(args: Array[String]): Unit = {
    print("OrderID","CusID","CustomerName","ProductID","ProductName","CatID","Category","ProductPrice","Qty","PayType","Valid","DatePurchased","CountryID","Country","Website")
    var generate = 0
    while (generate > 5000){
      ...
      val productNames = List((1, "Samsung Tablet", (1, "Tablets"), 299), (2, "S21 cell phone", (2, "Phones"), 1299), (3, "Sony Desktop", (3, "Computer"), 599),
      ...
      //Tuple fields for matching methods
      ...
      //The actual Tuple that will create the csv data
      val dataSet = Tuple1(newIDs, newNames, newProductNames, newQty, newPayType, validPay, newCountries, newWebSite)
      val info = dataSet.productIterator.exists(_)
      //info forEach (i => println(i))

        // var info2 = info.foreach(i => printIn(i))
